...
export function Form({ children, shorten, linkError }: FormProps) {
    ...
    return (
        <>
            <form action="" className="flex flex-col items-center justify-around w-full h-full 2xl:gap-x-8 2xl:flex-row 2xl:px-16">
                ...
                <button className="bg-cyan text-white text-xl w-10/12 h-10 rounded-md 2xl:w-3/12 2xl:rounded-xl 2xl:h-16" onClick={(e) => shorten(e, inputValue)}>Shorten it!</button>
            </form>
        </>
    )
}